...
public class LOOKSimulation extends JPanel {
    ...
    public LOOKSimulation(Main main, CardLayout layout, JPanel mainPanel, int width, int height,
        ...
        setLayout(null);
        backgroundImage = CommonConstants.loadImage(CommonConstants.simulation_screen_LOOK); // You might want to update
                                                                                             // this constant
    ...
    private void calculateLOOK() {
        // Implementation of LOOK algorithm (similar to SCAN but doesn't go to
        // boundaries)
