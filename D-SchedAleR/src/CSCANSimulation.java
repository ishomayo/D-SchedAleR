...
public class CSCANSimulation extends JPanel {
    ...
    public CSCANSimulation(Main main, CardLayout layout, JPanel mainPanel, int width, int height,
    ...
    private void calculateCSCAN() {
        // Implementation of C-SCAN algorithm (Circular SCAN)
